...
$I->see('Free Your Inner Geek');
$I->see('Find out more');
$I->see('The podcast about the business of freelancing as a software developer, writer, content producer, and all round PHP lover.');
...
// Test the links
$I->seeLink("Free The Geek.fm", "#page-top");
